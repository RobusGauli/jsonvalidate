...
The sources for jsonvalidate can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/robusgauli/jsonvalidate
.. _tarball: https://github.com/robusgauli/jsonvalidate/tarball/master
